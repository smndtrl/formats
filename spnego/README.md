# [RustCrypto]: Simple and Protected GSS-API Negotiation Mechanism (SPNEGO) Extension
...
Pure Rust implementation of Simple and Protected GSS-API Negotiation Mechanism (SPNEGO) Protocol Extension ([MS-SPNG]).
